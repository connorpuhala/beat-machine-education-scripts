...
This script generates individual PDF packets for each song from the songs_data.json file.
"""
...
def generate_song_packet(song_data, output_dir="song_packets"):
    ...
    tex_file = os.path.join(output_dir, f"{safe_filename}.tex")
    ...
    try:
        ...
        for ext in ['.aux', '.log', '.out']:
            aux_file = os.path.join(output_dir, f"{safe_filename}{ext}")
...
def main():
    ...
    print(f"📁 PDFs saved in: song_packets/\n")
